...
class Ui_PhylogeneticVisualization(object):
    def setupUi(self, PhylogeneticVisualization):
        ...
        self.actionSaveAs = QtGui.QAction(PhylogeneticVisualization)
    ...
    def retranslateUi(self, PhylogeneticVisualization):
        ...
        self.actionSaveAs.setText(_translate("PhylogeneticVisualization", "Save As", None))
        self.actionSaveAs.setShortcut(_translate("PhylogeneticVisualization", "Ctrl+S", None))
