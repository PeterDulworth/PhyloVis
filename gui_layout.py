...
class Ui_PhylogeneticVisualization(object):
    def setupUi(self, PhylogeneticVisualization):
        ...
        self.gridLayout_2.addItem(spacerItem14, 8, 0, 1, 1)
        ...
        self.gridLayout_2.addWidget(self.fileConverterBtn, 9, 0, 1, 1)
        ...
        self.selectFileConverterInputBtn = QtGui.QPushButton(self.inputPageNotRaxA)
        self.selectFileConverterInputBtn.setObjectName(_fromUtf8("selectFileConverterInputBtn"))
        self.horizontalLayout_23.addWidget(self.selectFileConverterInputBtn)
        self.selectFileConverterInputEntry = QtGui.QLineEdit(self.inputPageNotRaxA)
        self.selectFileConverterInputEntry.setObjectName(_fromUtf8("selectFileConverterInputEntry"))
        self.horizontalLayout_23.addWidget(self.selectFileConverterInputEntry)
...
" long names.", None))
        self.fileConverterBtn.setText(_translate("PhylogeneticVisualization", "Convert", None))
        ...
        self.selectFileConverterInputBtn.setText(_translate("PhylogeneticVisualization", "Choose File", None))
