...
class Ui_PhylogenicVisualization(object):
    ...
    def retranslateUi(self, PhylogenicVisualization):
        ...
        self.windowSizeLabel.setText(_translate("PhylogenicVisualization", "Window Size:", None))
        self.windowOffsetLabel.setText(_translate("PhylogenicVisualization", "Window Offset:", None))
